                ...
                <div class="card-body">
                    ...
                    {{ Form::model($setting,['url'=>'setting','method'=>'put'])}}
                        ...
                        <div class="form-group row">
                            <label class="col-md-2 col-form-label text-md-right">Nama Akademik</label>
                            <div class="col-md-4">
                                {{ Form::text('nama_akademik',null,['class'=>'form-control','placeholder'=>'Nama Akademik'])}}
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                                ...
                                <div class="col-md-3">
                                    {{ Form::text('no_telepon',null,['class'=>'form-control','placeholder'=>'No Telpon'])}}
                                </div>
